...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR Rockwool cold room clean room prefab building",
        competitors=["epack.in", "metecno.in", "epackpeb.com", "bansal-roofing.com"]
    )
