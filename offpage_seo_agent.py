...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer India PUF PIR cold room clean room insulation",
        competitors=["epack.in", "rinac.com", "mekarkprefab.com", "viraatindustries.com", "bnalprefabs.com"]
    )
