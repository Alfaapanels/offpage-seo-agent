...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer India PUF PIR cold room clean room insulated panels",
        competitors=["epack.in", "metecno.in", "bnalprefabs.com", "viraatindustries.com", "prontopanels.com"]
    )
