...
SITE_CONFIG = {
    ...
    "niche": "aluminium panels construction facade building materials",
    "competitors": [
        "eurobond.com.tr",
        "alucobond.com",
        "reynobond.com",
...
def run_offpage_seo_agent(
    your_domain: str = SITE_CONFIG["domain"],
    brand_name: str = SITE_CONFIG["brand_name"],
    niche: str = SITE_CONFIG["niche"],
        ...
        messages=[
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": f"""You are an expert off-page SEO strategist.
