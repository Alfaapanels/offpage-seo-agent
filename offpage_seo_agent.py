...
NICHE = "SMM panel social media marketing services reseller"
COMPETITORS = [
    "peakerr.com",
...
def categorize_brand_mention(mention_text: str, brand_name: str) -> str:
    ...
    positive_words = ["great", "best", "excellent", "recommend", "love", "amazing", "cheap", "fast", "reliable"]
    negative_words = ["bad", "worst", "avoid", "scam", "terrible", "poor", "slow", "expensive"]
...
def run_offpage_seo_agent(
    ...
    runner = client.beta.messages.tool_runner(
        ...
        messages=[
            {
                "role": "user",
                "content": f"""You are an expert off-page SEO strategist for SMM panels and social media marketing services.
Perform a complete off-page SEO analysis and build relevant backlinks for: {your_domain}
...
Search for "{brand_name}" and "alfaapanels" mentions online. Find unlinked mentions and opportunities.
Search: "{brand_name}" -site:{your_domain}
Also search: "alfaapanels" OR "alfa panels" -site:{your_domain}

TASK 2 - Competitor Backlink Research
For each competitor ({', '.join(competitors)}), find sites linking to them but not to {your_domain}.
Focus on SMM panel review sites, social media marketing blogs, and digital marketing resource pages.

TASK 3 - Link Building Opportunities in SMM Niche
Find resource pages, guest post opportunities, broken links, and directory listings in:
- SMM panel review and comparison sites
- Social media marketing blogs and forums
- Digital marketing tool directories
- Reseller panel communities
- Webmaster and SEO forums that discuss SMM tools

TASK 4 - Outreach Templates
Generate personalized email templates for the top 3 highest-scoring prospects found.

TASK 5 - Final Report
Create a prioritized 30-day off-page SEO action plan specifically for {your_domain} in the SMM panel niche.
Include specific sites to target, content ideas that attract backlinks, and forum/community engagement strategies.""",
            }
        ],
    )
