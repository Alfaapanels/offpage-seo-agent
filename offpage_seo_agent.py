...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer India insulated panels PUF PIR EPS rockwool cleanroom cold storage",
        competitors=["epack.in", "viraatindustries.com", "metecno.in", "industrialfoams.com", "engko.in"]
    )
