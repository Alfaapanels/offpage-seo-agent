...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="aluminum composite panels ACP cladding facade building materials exterior cladding",
        competitors=["alucobond.com", "reynobond.com", "alpolic.com", "maxbond.com", "alucoone.com"]
    )
