...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panels PUF PIR Rockwool clean room cold room panels India manufacturer",
        competitors=["epack.in", "rinac.com", "viraatindustries.com", "kingspanjindal.com"]
    )
