...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR cold room cleanroom prefab",
        competitors=["epack.in", "rinac.com", "metecno.in", "metaltree.in", "viraatindustries.com"]
    )
