...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer India PUF PIR Rockwool cold room clean room insulated panels",
        competitors=["epack.in", "kingspan.in", "lloydinsulations.com", "metecno.in"]
    )
