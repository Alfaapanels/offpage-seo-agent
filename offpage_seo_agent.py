...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer insulated PUF PIR rockwool cold room clean room panels India",
        competitors=["epack.in", "kingspanjindal.com", "rinac.com", "everestind.com"]
    )
