...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR Rockwool cold room clean room",
        competitors=["rinac.com", "epack.in", "icemakeindia.co.in", "lloydinsulations.com", "alfapebltd.com"]
    )
