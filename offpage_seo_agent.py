...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="PUF PIR sandwich insulated panels cold room clean room India manufacturer",
        competitors=["epack.in", "metecno.in", "viraatindustries.com", "panjetanibuildwell.com"]
    )
