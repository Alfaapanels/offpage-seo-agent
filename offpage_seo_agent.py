...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR cold room clean room warehouse industrial construction",
        competitors=["epack.in", "rinac.com", "kingspanjindal.com", "supersunprefab.com", "wonderpuf.com"]
    )
