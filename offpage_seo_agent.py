...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer insulated PUF PIR cold room clean room panels India",
        competitors=["nest-in.com", "koreapuff.com", "cactusprofiles.com", "metecno.in", "alfapebltd.com"]
    )
