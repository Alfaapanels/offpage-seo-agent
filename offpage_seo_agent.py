...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF panel roofing wall panels prefab construction",
        competitors=["epack.in", "kingspanjindal.com", "metecno.in", "rinac.com", "viraat.in"]
    )
