...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR cold storage cold room panels",
        competitors=["epack.in", "rinac.com", "metecno.in", "kingspan.com", "lloydinsulations.com"]
    )
