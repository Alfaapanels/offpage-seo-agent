...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR Rockwool cold room clean room panels",
        competitors=["epack.in", "rinac.com", "samanportable.com", "viraatpufpanel.com", "metecno.in"]
    )
