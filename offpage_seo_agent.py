...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panels PUF panels insulated panels manufacturer India cold storage clean room",
        competitors=["metecno.in", "koreapuff.in", "epack.in", "viraatindustries.com"]
    )
