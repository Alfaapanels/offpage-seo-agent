...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panels PUF PIR rockwool cold room clean room manufacturer India",
        competitors=["kingspanjindal.com", "epack.in", "rinac.com", "viraatindustries.com"]
    )
