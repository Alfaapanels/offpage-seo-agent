...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="PUF panels PIR rockwool insulation sandwich panels manufacturer India cold storage warehouse",
        competitors=["epack.in", "viraatindustries.com", "altiffoams.com", "prontopanels.com"]
    )
