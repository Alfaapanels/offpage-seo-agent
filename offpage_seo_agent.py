...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer India PUF EPS PIR Rockwool cold room clean room insulated panels",
        competitors=["epack.in", "viraatindustries.com", "rinac.com", "prontopanels.com", "trivenipanels.com"]
    )
