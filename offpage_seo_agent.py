...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="building panels facade panels sandwich panels wall cladding construction materials",
        competitors=["rockwool.com", "kingspaninsulation.com", "etalbondusa.com"],
    )
