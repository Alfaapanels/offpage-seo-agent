...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="aluminum composite panels, facade cladding, insulated sandwich panels, architectural cladding systems",
        competitors=["alucobond.com", "reynobond.com", "kingspan.com", "rockpanel.com", "trespa.com"],
    )
