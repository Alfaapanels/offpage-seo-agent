...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="sandwich panel manufacturer PUF PIR rockwool cold room clean room India",
        competitors=["epack.in", "panjetanibuildwell.com", "viraatindustries.com", "rinac.com"]
    )
