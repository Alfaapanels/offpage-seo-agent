...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturer India PUF PIR Rockwool clean room cold room panels",
        competitors=["epack.in", "koreapuff.in", "viraatindustries.com", "metecno.in", "kingspanjindal.com"]
    )
