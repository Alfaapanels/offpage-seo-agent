...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="aluminum composite panels ACP building facade cladding panels construction materials",
        competitors=["alucobond.com", "reynobond.com", "alucoworld.com", "alpolycbond.com"]
    )
