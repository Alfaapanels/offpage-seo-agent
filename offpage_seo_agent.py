...
if __name__ == "__main__":
    run_offpage_seo_agent(
        ...
        niche="insulated sandwich panel manufacturers India PUF panels wall roof panels",
        competitors=["epack.in", "rinac.com", "viraatpufpanel.com", "panjetanibuildwell.com"]
    )
